/* GENERATED FROM src/stealth.ts buildStealth({maskWebgl:true}) by tools-gen-python-assets.ts — DO NOT EDIT.
  ...
  try {
    ...
    if (proto) {
      ...
      proto.getParameter = function (p) {
        ...
        if (p === 37446) return "ANGLE (Intel, Mesa Intel(R) UHD Graphics)";
